...
const char* R3BGeoPspx::getModuleName(Int_t m)
{
    // Returns the module name of sts number m
    if (m < 0)
    {
        LOG(error) << "R3BGeoPspx::getModuleName:: Module number " << m << " not known!";
        return "";
    }
    if (m < 9)
...
const char* R3BGeoPspx::getEleName(Int_t m)
{
