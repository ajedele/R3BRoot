...
void R3BPspxContFact::setAllContainers()
{
    ...
    */
    ...
    FairContainer* p2 = new FairContainer("R3BPspxPoscalPar", "R3BPspx Poscal Parameters", "PspxDefaultContext");
...
FairParSet* R3BPspxContFact::createContainer(FairContainer* c)
{
    ...
    */
    ...
    if (strcmp(name, "R3BPspxPoscalPar") == 0)
    {
        p = new R3BPspxPoscalPar(c->getConcatName().Data(), c->GetTitle(), c->getContext());
    }
