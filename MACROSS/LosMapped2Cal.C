...
#include <iostream>
 extern "C" {
    //#include "/u/ajedele/R3BRoot_fork/r3bsource/base/ext_h101_unpack.h"
    //#include "/u/ajedele/R3BRoot_fork/r3bsource/trloii/ext_h101_tpat.h"
    //#include "/u/ajedele/R3BRoot_fork/r3bsource/trloii/R3BTrloiiTpatReader.h"
    #include "/u/land/r3broot/202402_s091_s118/R3BRoot/r3bsource/base/ext_h101_unpack.h"
    #include "/u/land/r3broot/202402_s091_s118/R3BRoot/r3bsource/trloii/ext_h101_tpat.h"
    //#include "/u/land/r3broot/202402_s091_s118/R3BRoot/r3bsource/trloii/R3BTrloiiTpatReader.h"
 }
...
void LosMapped2Cal(int RunId);

void LosMapped2Cal(){
	LosMapped2Cal(220); // 226 is last full run
}
...
void LosMapped2Cal(int RunId)
{
	...
	TString filename = path1 + "losrolu_" + runNumber1 + ".lmd --allow-errors --input-buffer=47Mi";
	printf("Input Filename: %s\n", filename.Data());
	TString outputFileName = path2 + "LosTCal" + runNumber1 + ".root";
	...
	parList->Add(new TObjString(path3 + "parameter/LosTCal0008.root"));
	...
	//((R3BLosMapped2Cal*)FairRuntimeDb::instance()->getContainer("R3BSampCal"))->printParams();
	run->Init();
