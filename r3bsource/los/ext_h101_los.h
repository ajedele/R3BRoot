...
#define EXT_STR_h101_LOS_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1VTRIGFI,                     UINT32,\
                    "LOS1VTRIGFI",                     "LOS1VTRIGF"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1VTRIGFv,                     UINT32,\
                    "LOS1VTRIGFv",                     "LOS1VTRIGF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     LOS1VTRIGC,                      UINT32,\
                    "LOS1VTRIGC",1); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1VTRIGCI,                     UINT32,\
                    "LOS1VTRIGCI",                     "LOS1VTRIGC"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1VTRIGCv,                     UINT32,\
                    "LOS1VTRIGCv",                     "LOS1VTRIGC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     LOS1TTFLM,                       UINT32,\
                    "LOS1TTFLM",8); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
  ...
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1TTRIGFLI,                    UINT32,\
                    "LOS1TTRIGFLI",                    "LOS1TTRIGFL"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1TTRIGFLv,                    UINT32,\
                    "LOS1TTRIGFLv",                    "LOS1TTRIGFL"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     LOS1TTRIGCL,                     UINT32,\
                    "LOS1TTRIGCL",1); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1TTRIGCLI,                    UINT32,\
                    "LOS1TTRIGCLI",                    "LOS1TTRIGCL"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     LOS1TTRIGCLv,                    UINT32,\
                    "LOS1TTRIGCLv",                    "LOS1TTRIGCL"); \
  \
} while (0);
